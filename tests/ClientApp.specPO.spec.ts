...
import{customTest} from '../utils_ts/test-base';// import utils_ts  folder file                                                 
import{POManager} from '../pageObjects_ts/POManager';// pageObjects change as pageObjects_ts
const dataset = JSON.parse(JSON.stringify(require("../utils_ts/placeorderTestData.json")));// utils_ts//json->string->js object  // पायरी 1: JSON फाईल import करा.
